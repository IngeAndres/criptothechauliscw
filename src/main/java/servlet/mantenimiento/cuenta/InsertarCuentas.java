 ...
 * @author Antho
 */
@WebServlet(name = "InsertarCuentas", urlPatterns = {"/insertarcuentas"})
public class InsertarCuentas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            boolean resultado = objCuentasJpaController.insertarCuentas(nuevaCuenta);
            if (resultado) {
