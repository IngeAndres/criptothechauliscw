    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for (Object[] transferData : transferencias) {
                ...
                transferMap.put("MONTO", transferData[5]);
                transferMap.put("NUMECUENTADESTINO", transferData[6]);
                transferMap.put("APPADESTINO", transferData[7]);
                transferMap.put("APMADESTINO", transferData[8]);
                transferMap.put("NOMBDESTINO", transferData[9]);
                transferMap.put("FECHA", transferData[10]);
